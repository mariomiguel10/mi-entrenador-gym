    ...
    <div className="max-w-2xl mx-auto px-4 py-10 animate-in zoom-in-95 duration-500">
      <div className="bg-white rounded-[3.5rem] shadow-2xl overflow-hidden border border-slate-100">
        ...
        <div className="p-8 sm:p-12 space-y-4">
          ...
          <button onClick={() => setView('active')} className="w-full mt-8 py-6 bg-indigo-600 text-white rounded-[2.5rem] font-black text-xl shadow-xl shadow-indigo-100 transition-all transform active:scale-95">Comenzar Entrenamiento</button>
        </div>
      </div>
    </div>
  );
